...
public struct SlideMenuOptions {
    public static var leftViewWidth: CGFloat = 140.0//270.0
    ...
    public static var hideStatusBar: Bool = false //true
...
public class SlideMenuController: UIViewController, UIGestureRecognizerDelegate {
    ...
    func initView() {
        ...
        leftContainerView.backgroundColor = UIColor(red: 0.45, green: 0.68, blue: 0.72, alpha: 1.0) //UIColor.clearColor()
